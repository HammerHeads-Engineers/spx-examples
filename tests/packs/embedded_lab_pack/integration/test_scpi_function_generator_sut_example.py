...
import tests.shared.integration.scpi_function_generator_sut_example as shared_scpi
...
class TestScpiFunctionGeneratorSUTExample(shared_scpi.TestScpiFunctionGeneratorSUTExample):
    """Run the shared SCPI function generator suite against installer instance."""
