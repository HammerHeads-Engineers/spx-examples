...
MODEL_KEY = "tests__scpi_sdm3055"
INSTANCE_KEY = "siglent_sdm3055_multimeter"
SPX_BASE_URL = os.environ.get("SPX_BASE_URL", "http://localhost:8000")


class TestScpiSiglentSdm3055SUTExample(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        try:
    ...
    def setUp(self):
        ...
        if self.instance is None:  # pragma: no cover - defensive
            self.skipTest("Siglent SDM3055 instance not initialised")
    ...
    def test_idn_matches_attribute(self):
        target = "SIGLENT,SDM3055,SDM3055S0000000,1.01"
