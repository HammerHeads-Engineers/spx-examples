...
import tests.shared.integration.modbus_vacuum_gauge_multichannel_sut_example as shared_vg
...
class TestModbusVacuumGaugeMultichannelSUTExampleIntegration(
    shared_vg.TestModbusVacuumGaugeMultichannelSUTExampleIntegration
):
    """Run the shared multichannel vacuum-gauge suite against installer-created instance."""
