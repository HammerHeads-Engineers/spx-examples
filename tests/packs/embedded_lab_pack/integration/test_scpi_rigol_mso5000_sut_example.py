...
MODEL_PATH = (
    ...
    / "rigol"
    / "rigol_mso5000__scpi.yaml"
)
MODEL_KEY = "tests__scpi_rigol_mso5000"
INSTANCE_KEY = "rigol_mso5000_oscilloscope"
SPX_BASE_URL = os.environ.get("SPX_BASE_URL", "http://localhost:8000")


class TestScpiRigolMso5000SutExample(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        try:
    ...
    def setUp(self):
        ...
        if self.instance is None:  # pragma: no cover - defensive
            self.skipTest("Rigol MSO5000 instance not initialised")
    ...
    def test_idn_matches_attribute(self):
        target = "RIGOL,MSO5000,MS5A000000000,00.01.00"
...
__all__ = ["TestScpiRigolMso5000SutExample"]
