...
import tests.shared.integration.modbus_prevac_mcd7_done_reset_stress as shared_stress
...
class TestModbusPrevacMCD7DoneResetStress(shared_stress.TestModbusPrevacMCD7DoneResetStress):
