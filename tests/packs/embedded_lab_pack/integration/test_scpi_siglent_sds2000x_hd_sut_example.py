...
MODEL_PATH = (
    ...
    / "siglent"
    / "siglent_sds2000x_hd__scpi.yaml"
)
MODEL_KEY = "tests__scpi_sds2000x_hd"
INSTANCE_KEY = "siglent_sds2000x_hd_oscilloscope"
SPX_BASE_URL = os.environ.get("SPX_BASE_URL", "http://localhost:8000")


class TestScpiSiglentSds2000xHdSutExample(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        try:
    ...
    def setUp(self):
        ...
        if self.instance is None:  # pragma: no cover - defensive
            self.skipTest("Siglent SDS2000X HD instance not initialised")
    ...
    def test_idn_matches_attribute(self):
        target = "SIGLENT,SDS2000X HD,SDS2HD0000000,1.0"
...
__all__ = ["TestScpiSiglentSds2000xHdSutExample"]
