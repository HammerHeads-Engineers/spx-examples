...
MODEL_PATH = (
    ...
    / "tektronix"
    / "tektronix_dmm4050__scpi.yaml"
)
MODEL_KEY = "tests__scpi_dmm4050"
INSTANCE_KEY = "tektronix_dmm4050_multimeter"
SPX_BASE_URL = os.environ.get("SPX_BASE_URL", "http://localhost:8000")


class TestScpiTektronixDmm4050SUTExample(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        try:
        ...
        if not wait_for_condition(cls._is_running, timeout=10.0, interval=0.2):
            raise AssertionError("DMM4050 instance did not reach running state.")
    ...
    def setUp(self):
        ...
        if self.instance is None:  # pragma: no cover - defensive
            self.skipTest("DMM4050 instance not initialised")
    ...
    def test_idn_matches_attribute(self):
        target = "TEKTRONIX,DMM4050,0000000,1.0"
