...
INSTANCE_KEY = "spx_energy_meter_pm3200_modbus"
MODEL_ID = "Energy.EnergyMeterPm3200.Modbus"


class TestModbusPm3200SUTExampleIntegration(unittest.TestCase):
    """Smoke test the PM3200 Modbus map via an installer-created instance."""
