...
"""Example SUT implementation: Modbus Prevac TSP04-PS client used in integration tests."""
...
DEFAULT_MODBUS_MAP: ModbusMap = {
    "pump1_status_word": {"address": 10, "decoder": "u16"},
    "pump1_output_current_a": {"address": 4, "decoder": "u16"},
    "pump1_output_voltage_v": {"address": 5, "decoder": "modbus_float_be", "bit_order": "ABCD"},
    "k__pump1_output_current_set_a": {"address": 3, "decoder": "u16"},
    "k__pump1_work_mode": {"address": 2, "decoder": "u16"},
}
...
def _decode_float_abcd(registers: Sequence[int]) -> float:
    return ModbusPrevacTSP04PSExample.modbus_to_float(registers, "ABCD")


class ModbusPrevacTSP04PSExample(ModbusSUTBase):
    """Thin wrapper around pymodbus representing the Prevac TSP04-PS Modbus model."""
...
__all__ = ["ModbusPrevacTSP04PSExample", "ModbusTcpClient"]
