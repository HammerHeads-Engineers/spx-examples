...
"""Example Rohde & Schwarz HMC8015 SCPI power analyzer SUT client."""
...
class ScpiRohdeSchwarzHmc8015SUTExample:
    """Very small helper bridging TCP sockets with HMC8015 SCPI commands."""
    ...
    def drain(self, timeout: float = 0.05) -> None:
        """Drain pending responses (e.g. echoes from write commands)."""
        sock = self._ensure_socket()
    ...
    def set_measurement_functions(self, functions: str) -> None:
        self.write(f"CHAN:MEAS:FUNC {functions}")

    def measurement_functions(self) -> str:
        return self.query("CHAN:MEAS:FUNC?")
...
__all__ = ["ScpiRohdeSchwarzHmc8015SUTExample"]
