...
"""Example SUT implementation: Modbus Prevac M1600PDC-PS client used in integration tests."""
...
DEFAULT_MODBUS_MAP: ModbusMap = {
    ...
    "power_set_w": {"address": 26, "decoder": "modbus_float_be", "bit_order": "ABCD"},
    "voltage_set_v": {"address": 28, "decoder": "modbus_float_be", "bit_order": "ABCD"},
    "current_set_ma": {"address": 30, "decoder": "modbus_float_be", "bit_order": "ABCD"},
    "frequency_khz": {"address": 32, "decoder": "modbus_float_be", "bit_order": "ABCD"},
    "pulse_duration_us": {"address": 34, "decoder": "modbus_float_be", "bit_order": "ABCD"},
    "flow_set_sccm": {"address": 36, "decoder": "modbus_float_be", "bit_order": "ABCD"},
}
...
def _decode_float_abcd(registers: Sequence[int]) -> float:
    return ModbusPrevacM1600PDCPSExample.modbus_to_float(registers, "ABCD")


class ModbusPrevacM1600PDCPSExample(ModbusSUTBase):
    """Thin wrapper around pymodbus representing the Prevac M1600PDC-PS Modbus model."""
...
__all__ = ["ModbusPrevacM1600PDCPSExample", "ModbusTcpClient"]
