...
"""Example Rohde & Schwarz HMP4040 SCPI power supply SUT client used by tests."""
...
class ScpiRohdeSchwarzHmp4040SUTExample:
    """Very small helper bridging TCP sockets with HMP4040 SCPI commands."""
    ...
    def select_output(self, channel: int) -> None:
    ...
    def output_state(self) -> int:
        return int(float(self.query(":OUTPut?")))
...
__all__ = ["ScpiRohdeSchwarzHmp4040SUTExample"]
